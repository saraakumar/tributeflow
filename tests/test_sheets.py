...
COLUMNS = {
    "tribute_type": "In Honor or Memory Of:",
...
def test_rows_parsed_with_header_mapping():
    values = [
        ["In Honor or Memory Of:", "Tribute Name", "Donor Name", "Image URL"],
        ["In memory of", "Bella", "Smith Family", ""],
        ["In honor of", "Max", "Lee", "https://example.com/max.jpg"],
    ]
    ...
    assert entries[0].tribute_type == "In memory of"
